...
# is to be played.
  ...
  def declare_victor(victor_num)
    if victor_num == 0
      ...
      print "\n#{victor_num == 1 ? @rulebook.valid_moves[@player1.choice] : @rulebook.valid_moves[@player2.choice]} \
      beats #{victor_num == 1 ? @rulebook.valid_moves[@player2.choice] : @rulebook.valid_moves[@player1.choice]}! \
